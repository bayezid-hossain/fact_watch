...
class NotificationPlugin {
  ...
  Future<void> showNotificationWithAttachment(News news) async {
    var attachmentPicturePath = await _downloadAndSaveFile(
        news.mediaLinkLarge.toString(),
        news.mediaLinkLarge.toString().substring(
            news.mediaLinkLarge.lastIndexOf('/'), news.mediaLinkLarge.length));
    var iOSPlatformSpecifics = IOSNotificationDetails(
      attachments: [IOSNotificationAttachment(attachmentPicturePath)],
    );
    var bigPictureStyleInformation = BigTextStyleInformation(
      news.title,
    );
    var androidChannelSpecifics = AndroidNotificationDetails(
      'Fact Watch',
    ...
    await flutterLocalNotificationsPlugin.show(
        news.id, news.title, "", notificationDetails,
        payload: jsonEncode(news));
  }
