        ...
        body: TabBarView(
          children: [
            ...
            SingleChildScrollView(
              child: Column(mainAxisAlignment: MainAxisAlignment.start,
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [ Padding(padding:EdgeInsets.all(10),child: Text("HOW WE FUND OUR WORK",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20),)),
                  Padding(padding:EdgeInsets.all(10),child: Text("Funding ",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18),)),
                  Padding(padding:EdgeInsets.all(10),child: Text("We started this initiative with a USD 25,000.00 support from the American Center, Dhaka that covered the operational costs for the first year. The American Centre is a non-political entity committed to fighting against misinformation. Since 2018, FactWatch has been sustaining itself without external funding, utilizing resources from the Media Studies and Journalism Department at ULAB.",style: TextStyle(fontWeight: FontWeight.normal,fontSize: 16),)),
                  Padding(padding:EdgeInsets.all(10),child: Text("Donations  ",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18),)),
                  Padding(padding:EdgeInsets.all(10),child: Text("We are open to donations from the public and non-political organizations interested ইন supporting our work, as long as our principles of non-partisanship and fairness are not compromised. Neither should donors expect to influence our claim selection or decision making in any shape or form. We reserve our independence and the standards and transparency of our methodology under all circumstances.",style: TextStyle(fontWeight: FontWeight.normal,fontSize: 16),)),
                ],
              )
            ),
          ],
