          ...
          children: [
            SingleChildScrollView(
              child: Column(mainAxisAlignment: MainAxisAlignment.start,
                ...
                children: [
                  Padding(padding:EdgeInsets.all(10),child: Text("অর্থকড়ি কীভাবে আসে ",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20,fontFamily: 'HindSiliguri'),)),
                  Padding(padding:EdgeInsets.all(10),child: Text("আর্থিক সহায়তা  ",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18,fontFamily: 'HindSiliguri'),)),
                  ...
                  Padding(padding:EdgeInsets.all(10),child: Text("অনুদান  ",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18,fontFamily: 'HindSiliguri'),)),
            ...
            SingleChildScrollView(
              child: Column(mainAxisAlignment: MainAxisAlignment.start,
                ...
                children: [ Padding(padding:EdgeInsets.all(10),child: Text("HOW WE FUND OUR WORK",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20,fontFamily: 'BalooDa2'),)),
                  ...
                  Padding(padding:EdgeInsets.all(10),child: Text("Donations  ",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18,fontFamily: 'HindSiliguri'),)),
