            ...
            SingleChildScrollView(
              child: Column(
                ...
                children: [
                      ...
                      SizedBox( height:10),
                      Padding(padding:EdgeInsets.only(left: 10),child: Text("ইউনিভার্সিটি অব লিবারেল আর্টস-এর গণমাধ্যম ও সাংবাদিকতা বিভাগের অধ্যাপক। অফিস অব ফ্যাকাল্টি রিসার্চ-এর পরিচালক। সেন্টার ফর ক্রিটিক্যাল এন্ড কোয়ালিটেটিভ স্টাডিজ এর পরিচালক। গণমাধ্যম এবং সাংবাদিকতা  বিষয়ে বিশেষজ্ঞ হিসেবে সুপরিচিত। বাংলাদেশে মিডিয়া ও ইনফরমেশন লিটারেসি নিয়ে আলাপের প্রবক্তা। ",style: TextStyle(fontFamily: 'Kalpurush'),)),
                  SizedBox( height:10),
                  Padding(padding:EdgeInsets.only(left: 10),child: Text("পড়াশুনা করেছেন দর্শন, উন্নয়ন-অধ্যয়ন ও দক্ষিণ এশীয় অধ্যয়নে। পিএইচডি করেছেন সাংস্কৃতিক অধ্যয়নে, ইউনিভার্সিটি অব কুইনসল্যান্ড, অস্ট্রেলিয়া থেকে। পপুলার কালচার, কালচারাল স্টাডিজ এবং সাহিত্যের বিভিন্ন শাখায় সুমন রহমানের লেখালেখি আছে।",style: TextStyle(fontFamily: 'Kalpurush'),)),
                  SizedBox( height:10),
                  Row(children:[Padding(padding:EdgeInsets.only(left: 10),child: Text("তাঁর সাথে যোগাযোগ করতে ইমেইল: ",style: TextStyle(fontFamily: 'Kalpurush'),),),InkWell(
                    onTap: () {
                  ...
                  SizedBox( height:10),
                  Padding(padding:EdgeInsets.only(left: 10),child: Text("ইউল্যাবের মিডিয়া স্টাডিজ ও জার্নালিজম বিভাগের গণযোগাযোগ বিষয়ে পড়ছেন। ফ্যাক্ট চেকিং এ প্রযুক্তি, পরিসংখ্যান এবং উপাত্তের ভূমিকা নিয়ে বিশেষ আগ্রহী।",style: TextStyle(fontFamily: 'Kalpurush'),)),
                  SizedBox( height:10),
                  ...
                  Padding(padding:EdgeInsets.only(left: 10),child: Text("ফ্যাক্ট চেকার",style: TextStyle(color: Colors.black,fontSize: 15,fontWeight: FontWeight.bold,fontFamily: 'BalooDa2'),)),
                  SizedBox( height:10),
                  Padding(padding:EdgeInsets.only(left: 10),child: Text("ইউল্যাবের মিডিয়া স্টাডিজ ও জার্নালিজম বিভাগের তৃতীয় বর্ষে অধ্যয়নরত। পড়তে এবং লিখতে ভালবাসেন। বিভিন্ন দৈনিকে তার লেখা প্রবন্ধ প্রকাশিত হয়েছে। ভবিষ্যতে অপতথ্য়, গুজব, ভুয়া খবর নিয়ে গবেষণা করতে আগ্রহী।",style: TextStyle(fontFamily: 'Kalpurush'),)),
                  SizedBox( height:10),
            ...
            SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  SizedBox( height:10),
                  Padding(padding:EdgeInsets.only(left: 10),child: Text("Professor of Journalism and Media Studies at ULAB and director of the Office of Faculty Research and the Center for Critical and Qualitative Studies (CQS). He is an esteemed media expert and a pioneer in the field of information literacy. ",style: TextStyle(fontFamily: 'Kalpurush'),)),
                  SizedBox( height:10),
                  Padding(padding:EdgeInsets.only(left: 10),child: Text("Dr. Rahman’s academic background is in Philosophy, Development Studies and South Asian Studies, with a PhD in Cultural Studies from the University of Queensland, Australia. As a writer, he has published on popular culture, cultural studies, as well as works of literature.",style: TextStyle(fontFamily: 'Kalpurush'),)),
                  SizedBox( height:10),
                  ...
                  SizedBox( height:10),
                  Padding(padding:EdgeInsets.only(left: 10),child: Text("Dr. Nafees Mansoor is an Assistant Professor in the Department of Computer Science and Engineering at ULAB with a Ph.D. from Universiti Teknologi Malaysia (UTM). He advises the FactWatch team on the technical maintenance of platforms as well as the use of technology in fact-checking.",style: TextStyle(fontFamily: 'Kalpurush'),)),
                  SizedBox( height:10),
                  Padding(padding:EdgeInsets.only(left: 10),child: Text("Dr. Mansoor has more than 10 years work experience both in academia and industry. He has published at least 60 research articles in various reputed journals and international conferences. ",style: TextStyle(fontFamily: 'Kalpurush'),)),
                  SizedBox( height:10),
                  Row(children:[Padding(padding:EdgeInsets.only(left: 10),child: Text("He can be reached at: "),),InkWell(
                    onTap: () {
                      Functionalities.launchURL("mailto:nafees.mansoor@ulab.edu.bd");
                  ...
                  Padding(padding:EdgeInsets.only(left: 10),child: Text("Fact Checker",style: TextStyle(color: Colors.black,fontSize: 15,fontWeight: FontWeight.bold,fontFamily: 'BalooDa2'),)),
                  SizedBox( height:10),
                  Padding(padding:EdgeInsets.only(left: 10),child: Text("Apon has is a student of Media Studies & Journalism at ULAB. He loves to read and write. He has published articles in several national dailies. Apon would like to pursue academic research into misinformation, disinformation, rumors, and fake news.",style: TextStyle(fontFamily: 'Kalpurush'),)),
                  SizedBox( height:10),
